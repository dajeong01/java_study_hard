...
public class Condition02 {
    public static void main(String[] args) {
        ...
        if(point > VIP){
            System.out.println("당신은 VIP등급입니다.");
        } else if(point > GOLD) {
        ...
        /*
            ...
            그런데 , 왜 이번에는 저 위에 먼저 선언해놓고, 재입대하는 방식으로 작성했는가.

            다른 사람들과의 협업을 염ㄷ두에 두고 사용되는 클래스 및 변숟들을 초반부에 전부
            선언한 뒤 실제로 사용할 때 재입대를 하는 방식으로 작성하는 것이 가독성을 염두에 둔 코드라고
            할 수 있다.
